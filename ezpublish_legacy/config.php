...
/* 
Configurazione opencontent di config.php di produzione
Vedi https://support.opencontent.it/opencontent/wiki/config.php
*/

/* 
Limita ImageMagick all'utilizzo di un solo processore
vedi:
 http://share.ez.no/forums/install-configuration/imagemagick-causes-high-server-load-when-opening-gallery
 http://www.daniloaz.com/en/617/systems/high-cpu-load-when-converting-images-with-imagemagick/
*/
putenv( "MAGICK_THREAD_LIMIT=1" );

/*
Abilita le cache degli ini
Inserito da Francesco il 18 settembre 2013
Set EZP_INI_FILEMTIME_CHECK constant to false to improve performance by
not checking modified time on ini files.
*/    
define( 'EZP_INI_FILEMTIME_CHECK', false );
