...
<div class="object">
<p>
{"The currently published version is %version and was published at %time."|i18n('design/ocbootstrap/content/edit_draft',,hash('%version',$object.current_version,'%time',$object.published|l10n(datetime) ))}
</p>
<p>
{"The last modification was done at %modified."|i18n('design/ocbootstrap/content/edit_draft',,hash('%modified',$object.modified|l10n(datetime)))}
</p>
<p>
...
<tr>
    ...
    {/section}
    <th>
        {'Version'|i18n('design/ocbootstrap/content/edit_draft')}
    </th>
    <th>
        {'Name'|i18n('design/ocbootstrap/content/edit_draft')}
    </th>
    <th>
        {'Owner'|i18n('design/ocbootstrap/content/edit_draft')}
    </th>
    <th>
        {'Created'|i18n('design/ocbootstrap/content/edit_draft')}
    </th>
    <th>
        {'Last modified'|i18n('design/ocbootstrap/content/edit_draft')}
    </th>
</tr>
...
{section show=and($has_own_drafts,$has_other_drafts)}
    <input class="defaultbutton" type="submit" name="EditButton" value="{'Edit'|i18n('design/ocbootstrap/content/edit_draft')}" />
    <input class="button" type="submit" name="NewDraftButton" value="{'New draft'|i18n('design/ocbootstrap/content/edit_draft')}" />
{section-else}
    {section show=$has_own_drafts}
        <input class="defaultbutton" type="submit" name="EditButton" value="{'Edit'|i18n('design/ocbootstrap/content/edit_draft')}" />
        <input class="button" type="submit" name="NewDraftButton" value="{'New draft'|i18n('design/ocbootstrap/content/edit_draft')}" />
    {/section}
    {section show=$has_other_drafts}
        <input class="defaultbutton" type="submit" name="NewDraftButton" value="{'New draft'|i18n('design/ocbootstrap/content/edit_draft')}" />
    {/section}
{/section}
