...
<input class="button" type="submit" name="EmptyButton" value="{'Empty draft'|i18n('design/ocbootstrap/content/draft')}" />
</div>
...
<tr class="{$style}">
    ...
    <td width="1">
        <a href={concat("/content/edit/",$draft.contentobject.id,"/",$draft.version,"/")|ezurl}><img src={"edit.gif"|ezimage} alt="{'Edit'|i18n('design/ocbootstrap/content/draft')}" /></a>
    </td>
</tr>
{/foreach}
<tr class="bgdark">
    <td colspan="1" align="left" width="1">
        <input type="image" name="RemoveButton" value="{'Remove'|i18n('design/ocbootstrap/content/draft')}" src={"trash.gif"|ezimage} />
    </td>
    <td colspan="7">
    </td>
</tr>
</table>
<input class="button" name="selectall" onclick=checkAll() type="button" value="{'Select all'|i18n('design/ocbootstrap/content/draft')}" />
