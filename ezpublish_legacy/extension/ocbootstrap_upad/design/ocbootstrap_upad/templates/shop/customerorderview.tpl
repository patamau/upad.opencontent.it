        ...
        <div class='col-lg-12 col-md-12 col-sm-12 m_bottom_30'>
            ...
            <div class="shop-customerorderview">
                <div class="attribute-header">
                    <h2 class="tt_uppercase color_dark m_bottom_25">{"Customer information"|i18n("design/ocbootstrap/shop/customerorderview")}</h2>
                </div>
            ...
            <div class="attribute-header">
                <h2 class="tt_uppercase color_dark m_bottom_25">{"Order list"|i18n("design/ocbootstrap/shop/customerorderview")}</h2>
            </div>
            ...
            <tr>
                <th>
                {"ID"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
                <th>
                {"Date"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
                <th>
                {"Total ex. VAT"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
                <th>
                {"Total inc. VAT"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
                <th>
                </th>
            </tr>
            ...
            <tr class="{$Order.sequence}">
                ...
                <td>
                <a class="btn btn-info btn-xs" href={concat("/shop/orderview/",$Order.item.id,"/")|ezurl}>Dettaglio</a>
                </td>
            </tr>
            {/section}
            </table>
            ...
            <div class="attribute-header">
                <h2 class="tt_uppercase color_dark m_bottom_25">{"Purchase list"|i18n("design/ocbootstrap/shop/customerorderview")}</h2>
            </div>
            ...
            <tr>
                <th>
                {"Product"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
                <th>
                {"Amount"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
                <th>
                {"Total ex. VAT"|i18n("design/ocbootstrap/shop/customerorderview")}
                </th>
