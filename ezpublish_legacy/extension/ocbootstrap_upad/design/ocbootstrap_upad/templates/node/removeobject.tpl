...
<div class="container">
    ...
    {/if*}
        ...
        <input type="hidden" name="MoveToTrash" value="0" checked="checked" />

        <br />
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="buttonblock">
                    {include uri="design:gui/defaultbutton.tpl" name=Discard id_name=CancelButton value="Cancel"|i18n("design/ocbootstrap/node/removeobject")}
                    {include uri="design:gui/button.tpl" name=Store id_name=ConfirmButton value="Confirm"|i18n("design/ocbootstrap/node/removeobject") disabled=$exceeded_limit}
                </div>
            </div>
        </div>
