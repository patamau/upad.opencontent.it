                    ...
                    {if count($content_attributes)|gt(0)}
                        <div class="row">
                            <div class='col-lg-6 col-md-6 col-sm-6 '>
                                {foreach $content_attributes as $attribute max 8}
                            ...
                            <div class='col-lg-6 col-md-6 col-sm-6 '>
                                {foreach $content_attributes as $attribute offset 8 max 9}
                                    <div class='form-group m_bottom_15'>
                                        <input type="hidden" name="ContentObjectAttribute_id[]" value="{$attribute.id}" />
                                        {attribute_edit_gui attribute=$attribute html_class="form-control" placeholder=$attribute.contentclass_attribute.name}
                                    </div>
                        ...
                        <div class="row">
                            <div class='col-lg-12 col-md-12 col-sm-12'>
                                ...
                                {foreach $content_attributes as $attribute offset 17}
                                    <div class='form-group m_bottom_15'>
                                        <input type="hidden" name="ContentObjectAttribute_id[]" value="{$attribute.id}" />
                                        {attribute_edit_gui attribute=$attribute html_class="form-control" placeholder=$attribute.contentclass_attribute.name}
                                    </div>
