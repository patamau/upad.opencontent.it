    ...
    <div class="row clearfix">
        <section class='col-lg-12 col-md-12 col-sm-12 m_bottom_30'>
            <div class=" clearfix">
                ...
                <form method="post" action={"invoice/report_aree"|ezurl}  class="form-inline m_bottom_30">
                ...
                {if gt($search_results|count(), 0)}
                    ...
                    <div class="pull-right">
                        <a href="{concat( 'layout/set/a4/invoice/export_aree/', $ente, '/', $mese, '/', $anno, '/', $stato)|ezurl(no)}" class="btn btn-danger">Stampa</a>
                    </div>
                {else}
                    {if $ente}
