...
<div class="container">
    ...
    <section class="col-lg-9 col-md-9 col-sm-8 m_xs_bottom_30">
        ...
        {if and( $data.is_search_request, is_set($view_parameters.class_id) )}
            ...
            $count = $data.count}
        {else}
            {set $children = fetch( 'content', 'tree', hash( parent_node_id, 2, main_node_only, true(), class_filter_type, 'include', 'class_filter_array', array( 'corso' ),
            	...
            	'limit', $page_limit, 'offset', $view_parameters.offset, sort_by, array( 'name', true() ) 
            ))
