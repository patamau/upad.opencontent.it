...
<table class="table" cellspacing="0" cellpadding="0" border="0"  style="width:100%">
  <tr>
    ...
    <p>
      {'Name'|i18n('design/standard/shop')}: {$invoice.user.contentobject.name|wash()}<br />
    ...
    <td valign="top" style="width: 50%">
      ...
      {'Country/region'|i18n('design/standard/shop')}: {$invoice.user.contentobject.data_map.luogo_residenza.content|wash()}<br />
      </p>
    </td>
  </tr>
</table>
