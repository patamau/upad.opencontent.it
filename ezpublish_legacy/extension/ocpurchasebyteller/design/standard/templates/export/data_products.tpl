...
<tbody>
<tr>
    <td>Ricevuta nr: <strong>%NUMBER%</strong> del <strong>%DATE%</strong></td>
</tr>
</tbody>
</table>
...
<table class="table" cellspacing="0" cellpadding="0" border="0"  style="width:100%">
  <tr>
    ...
    <td valign="top" style="width: 50%">
      ...
      {'Street'|i18n('design/standard/shop')}: {$invoice.reference_order.account_information.street2}<br />
...
<tr>
    ...
    <th><strong>Prezzo unitario</strong></th>
    <th><strong>Prezzo complessivo</strong></th>
</tr>
</thead>
<tbody>
...
<tbody>
    ...
    <tr>
        <th colspan="4"><b>Totale a pagare</b></th>
