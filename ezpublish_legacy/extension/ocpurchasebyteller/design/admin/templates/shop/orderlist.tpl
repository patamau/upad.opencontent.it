...
<tr>
    ...
    <th class="wide">Ente</th>
    <th class="wide">Nome corso</th>
...
<tr class="{$Orders.sequence}">
    ...
    <td>{attribute_view_gui attribute=$Orders.item.product_items[0].item_object.contentobject.current.data_map.ente}</td>
    <td>{$Orders.item.product_items[0].object_name|attribute(show)}</td>
    <td>
