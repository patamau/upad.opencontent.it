...
<div class="block">
    ...
    <div class="element">
        ...
        <select name="{$attribute_base}_birthday_day_{$attribute.id}" title="{"Please enter the day"|i18n("design/standard/content/datatype")}" class="{$attribute.contentclass_attribute_identifier}_day">
            <option value=""></option>
        {for 1 to 31 as $i}
    ...
    <div class="element">
        ...
        <select name="{$attribute_base}_birthday_month_{$attribute.id}" title="{"Please enter the month"|i18n("design/standard/content/datatype")}" class="{$attribute.contentclass_attribute_identifier}_month">
            <option value=""></option>
        {for 1 to 12 as $i}
    ...
    <div class="element">
        ...
        <select name="{$attribute_base}_birthday_year_{$attribute.id}" title="{"Please enter the year"|i18n("design/standard/content/datatype")}" class="{$attribute.contentclass_attribute_identifier}_year">
            <option value=""></option>
