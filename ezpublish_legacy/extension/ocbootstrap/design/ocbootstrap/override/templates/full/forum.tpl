    ...
    <div class="table-responsive">
      <table class="table table-striped forum" cellspacing="0">
        <tr>
            ...
            <th class="replies">
                {"Replies"|i18n( "design/ocbootstrap/full/forum" )}
            </th>
            <th class="author">
                {"Author"|i18n( "design/ocbootstrap/full/forum" )}
            </th>
            <th class="lastreply">
                {"Last reply"|i18n( "design/ocbootstrap/full/forum" )}
            </th>
        </tr>
        ...
        {if $topic_count}
            ...
            <tr class="{$topic.sequence}">
                <td class="topic{section show=$topic.object.data_map.sticky.content} danger{/section}">
                    
                    <a href={$topic.url_alias|ezurl}>{$topic.object.name|wash}</a></p>
                    {section show=$topic_reply_count|gt( sub( 20, 1 ) )}
                        <p>
                        {'Pages'|i18n( 'design/ocbootstrap/full/forum' )}:
