...
<img src={$image_variation.full_path|ezroot} alt="{$object.data_map.image.content.alternative_text|wash(xhtml)}" class="img-responsive {if $object_parameters.align|eq('center')}center-block{/if}" />
