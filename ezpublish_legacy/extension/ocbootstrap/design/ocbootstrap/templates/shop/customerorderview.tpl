<div class="shop-customerorderview">
    <div class="attribute-header">
        <h1 class="long">{"Customer information"|i18n("design/ocbootstrap/shop/customerorderview")}</h1>
    </div>
...
<div class="attribute-header">
    <h1>{"Order list"|i18n("design/ocbootstrap/shop/customerorderview")}</h1>
</div>
...
<div class="attribute-header">
  <h1>{"Purchase list"|i18n("design/ocbootstrap/shop/customerorderview")}</h1>
</div>
