...
<ul>
    <li class="selected">1. {"Shopping basket"|i18n("design/ocbootstrap/shop/basket")}</li>
    <li>2. {"Account information"|i18n("design/ocbootstrap/shop/basket")}</li>
    <li>3. {"Confirm order"|i18n("design/ocbootstrap/shop/basket")}</li>
</ul>
...
<tr class="bglight">
    <td colspan="6"><input class="button" type="submit" name="StoreChangesButton" value="{'Update'|i18n('design/ocbootstrap/shop/basket')}" /></td>
    <td colspan="1"><input class="button" type="submit" name="RemoveProductItemButton" value="{'Remove'|i18n('design/ocbootstrap/shop/basket')}" /> </td>
</tr>
...
<input class="button" type="submit" name="ContinueShoppingButton" value="{'Continue shopping'|i18n('design/ocbootstrap/shop/basket')}" />
<input class="button" type="submit" name="CheckoutButton" value="{'Checkout'|i18n('design/ocbootstrap/shop/basket')}" /> &nbsp;
</div>
