...
<ul>
     <li>1. {"Shopping basket"|i18n("design/ocbootstrap/shop/userregister")}</li>
     <li class="selected">2. {"Account information"|i18n("design/ocbootstrap/shop/userregister")}
</li>
     <li>3. {"Confirm order"|i18n("design/ocbootstrap/shop/userregister")}</li>
</ul>
...
<div class="block">
<label>
{"Company"|i18n("design/ocbootstrap/shop/userregister")}:
</label><div class="labelbreak"></div>
...
<div class="buttonblock">
    <input class="button" type="submit" name="CancelButton" value="{"Cancel"|i18n('design/ocbootstrap/shop/userregister')}" />
    <input class="defaultbutton" type="submit" name="StoreButton" value="{"Continue"|i18n( 'design/ocbootstrap/shop/userregister')}" />
</div>
