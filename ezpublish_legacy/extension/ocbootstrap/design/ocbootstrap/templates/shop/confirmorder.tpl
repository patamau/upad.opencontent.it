...
<ul>
    <li>1. {"Shopping basket"|i18n("design/ocbootstrap/shop/confirmorder")}</li>
    <li>2. {"Account information"|i18n("design/ocbootstrap/shop/confirmorder")}</li>
    <li class="selected">3. {"Confirm order"|i18n("design/ocbootstrap/shop/confirmorder")}</li>
</ul>
...
<h3>{"Product items"|i18n("design/ocbootstrap/shop/confirmorder")}</h3>
...
<h3>{"Order summary"|i18n("design/ocbootstrap/shop/confirmorder")}:</h3>
...
<input class="button" type="submit" name="CancelButton" value="{'Cancel'|i18n('design/ocbootstrap/shop/confirmorder')}" /> &nbsp;
<input class="button" type="submit" name="ConfirmOrderButton" value="{'Confirm'|i18n('design/ocbootstrap/shop/confirmorder')}" /> &nbsp;
</div>
