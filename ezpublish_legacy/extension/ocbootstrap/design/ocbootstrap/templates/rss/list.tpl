...
<tr>
    <th class="tight"><img src={'toggle-button-16x16.gif'|ezimage} alt="{'Invert selection'|i18n( 'design/ocbootstrap/rss/list' )}" onclick="ezjs_toggleCheckboxes( document.rssexportslist, 'DeleteIDArray[]' ); return false;" title="{'Invert selection.'|i18n( 'design/ocbootstrap/rss/list' )}" /></th>
...
<tr class="{$RSSExports.sequence}">
    ...
    {* Remove. *}
    <td><input type="checkbox" name="DeleteIDArray[]" value="{$RSSExports.item.id}" title="{'Select RSS export for removal.'|i18n( 'design/ocbootstrap/rss/list' )}" /></td>
    ...
    {* Status. *}
    <td>{section show=$RSSExports.item.active|eq( 1 )}{'Active'|i18n( 'design/ocbootstrap/rss/list' )}{section-else}{'Inactive'|i18n( 'design/ocbootstrap/rss/list' )}{/section}</td>
    ...
    {* Edit. *}
    <td><a href={concat( 'rss/edit_export/', $RSSExports.item.id )|ezurl}><img class="button" src={'edit.gif'|ezimage} width="16" height="16" alt="{'Edit'|i18n( 'design/ocbootstrap/rss/list' )}" title="{'Edit the <%name> RSS export.'|i18n('design/ocbootstrap/rss/list',, hash( '%name', $RSSExports.item.title) )|wash}" /></a></td>
...
<div class="block">
    <input type="submit" name="RemoveExportButton" value="{'Remove selected'|i18n( 'design/ocbootstrap/rss/list' )}" title="{'Remove selected RSS exports.'|i18n( 'design/ocbootstrap/rss/list' ) }" {section show=$rssexport_list|not}class="button-disabled" disabled="disabled"{section-else}class="button"{/section}
/>
    <input class="button" type="submit" name="NewExportButton" value="{'New export'|i18n( 'design/ocbootstrap/rss/list' )}" title="{'Create a new RSS export.'|i18n( 'design/ocbootstrap/rss/list' )}" />
</div>
