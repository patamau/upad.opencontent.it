...
{if and( $content_object.can_create, $is_container )}
        ...
        <select name="ClassID" class='select2 form-control'>            
        ...
        <input class="btn btn-primary btn-block" type="submit" name="NewButton" value="{'Create here'|i18n('design/standard/parts/website_toolbar')}" />
{/if}
