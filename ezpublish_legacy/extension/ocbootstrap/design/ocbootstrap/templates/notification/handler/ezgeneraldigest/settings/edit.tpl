...
<div class="block">
    <label><input type="checkbox" name="ReceiveDigest_{$handler.id_string}" {$settings.receive_digest|choose( '', checked)} /> {'Receive all messages combined in one digest'|i18n( 'design/ocbootstrap/notification/handler/ezgeneraldigest/settings/edit' )}</label>
</div>

<div class="block">
<fieldset>
<legend>{'Receive digests'|i18n( 'design/ocbootstrap/notification/handler/ezgeneraldigest/settings/edit' )}</legend>
<table cellspacing="4">
<tr>
<td>
