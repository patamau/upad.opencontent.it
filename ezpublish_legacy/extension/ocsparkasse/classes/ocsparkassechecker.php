<?php
//
// Definition of oCSparkasseChecker class
//
...
class ocSparkasseChecker extends eZPaymentCallbackChecker
{
    /*!
        Constructor.
    */
    function ocSparkasseChecker( $iniFile )
    {
        $this->eZPaymentCallbackChecker( $iniFile );
        $this->logger = eZPaymentLogger::CreateForAdd( 'var/log/oCSparkasseChecker.log' );
    }
